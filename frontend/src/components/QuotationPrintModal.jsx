...
const QuotationPrintModal = ({ isOpen, onClose, quotation, printType = 'detailed' }) => {
  ...
  return (
    <div className="custom-modal-overlay no-print-bg">
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
            <div style={{ fontWeight: 700, fontSize: '14px', whiteSpace: 'nowrap' }}>
              🖨️ Quotation Print: {quotation.quotation_number}
            </div>
        ...
        {/* Printable Quotation Content (Targeted for window.print) */}
        <div style={{ overflowY: 'auto', flex: 1, background: '#fff', padding: '10px' }}>
          <div className="quotation-print-container printable-area">
              ...
              <div className="print-header" style={{ display: 'block', borderBottom: '2px solid #1a2f5a', paddingBottom: '8px', marginBottom: '8px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
                  ...
                  <div style={{ textAlign: 'right', minWidth: '220px' }}>
                    <div style={{ fontSize: '18px', fontWeight: 800, color: '#1a2f5a', letterSpacing: '1px', marginBottom: '4px' }}>
                      Price Quotation
                    </div>
            ...
            {/* Quotation To & Delivery Address Boxes */}
            <div style={{ display: 'flex', gap: '20px', marginBottom: '16px', width: '100%' }}>
              <div className="customer-print-box" style={{ flex: 1, margin: 0, width: 'auto' }}>
                <div className="box-header">Quotation To:</div>
              ...
              {(quotation.delivery_address || quotation.deliveryAddress) && (
                <div className="customer-print-box" style={{ flex: 1, margin: 0, width: 'auto' }}>
                  <div className="box-header" style={{ background: '#ff7b00', color: '#fff' }}>Delivery Address:</div>
                  <div className="box-body" style={{ minHeight: '80px' }}>
                    <div style={{ whiteSpace: 'pre-line' }}>{quotation.delivery_address || quotation.deliveryAddress}</div>
                  </div>
                </div>
              )}
            </div>
              ...
              <tbody>
                ...
                <tr className="total-row" style={{ background: '#f8f9fa' }}>
                  <td colSpan={isDetailed ? 9 : 5} style={{ textAlign: 'right', fontWeight: 700, fontSize: '13px' }}>
                    Total for this Quotation Value
                  </td>
                  <td style={{ textAlign: 'right', fontWeight: 800, fontSize: '14px', color: '#000' }}>
                    {(parseFloat(quotation.net_amount) || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="words-box">
              <strong>Amount in Words: </strong> {numberToWords(quotation.net_amount)}
            </div>
            ...
            <div className="signatures-row">
              <div className="sig-box">
                ...
                <strong>Quotation Received By</strong>
              </div>
              <div className="sig-box" style={{ textAlign: 'right' }}>
                <div className="sig-line"></div>
                <strong>Sales (Dhaka Blinds)</strong>
              </div>
            </div>
