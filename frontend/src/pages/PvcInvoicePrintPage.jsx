      ...
      >
        ...
        {!isPad ? (
          <div className="print-header" style={{ display: 'block', marginBottom: '8px' }}>
            ...
            <div style={{ fontSize: '11px', color: '#000000', textAlign: 'center', fontWeight: '700', marginBottom: '2px', textTransform: 'uppercase', letterSpacing: '0.3px' }}>
              Office Address : {brand.officeAddress}
            </div>
            <div style={{ fontSize: '11px', color: '#000000', textAlign: 'center', fontWeight: '700', paddingBottom: '4px', marginBottom: '2px', letterSpacing: '0.3px' }}>
          ...
          <div style={{ display: 'block', marginBottom: '8px' }}>
            ...
            <div style={{ fontSize: '11px', color: '#000000', textAlign: 'center', fontWeight: '700', paddingBottom: '4px', borderBottom: '1px solid #000000', marginBottom: '4px', letterSpacing: '0.3px' }}>
              Mobile : {brand.mobile}, &nbsp;Email : {brand.email}, &nbsp;Web : {brand.web}{brand.vatRegNo ? <>, &nbsp;VAT Reg No : {brand.vatRegNo}</> : ''}
            </div>
            <div style={{ textAlign: 'center', marginBottom: '2px' }}>
              <div style={{ fontSize: '24px', fontWeight: 'bold', fontFamily: '"David", "David Libre", "Times New Roman", serif', color: '#000000', textAlign: 'center', lineHeight: 1.1 }}>Invoice</div>
            </div>
          </div>
        )}

        {/* Bill To & Delivery Address Section with Date & Invoice No on Right */}
        {(invoice?.delivery_address || quotation?.delivery_address) ? (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '20px', marginBottom: '16px' }}>
            ...
            <div style={{ textAlign: 'right', fontSize: '12px', lineHeight: '1.6', minWidth: '190px', flexShrink: 0, color: '#000000' }}>
