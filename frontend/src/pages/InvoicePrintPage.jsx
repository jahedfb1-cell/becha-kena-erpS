...
// quotation builder and on the quotation/challan print pages.
      ...
      >
        ...
        {!isPad ? (
          ...
          <div style={{ display: 'block', marginBottom: '8px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '2px' }}>
              <div style={{ fontSize: '24px', fontWeight: 'bold', fontFamily: '"David", "David Libre", "Times New Roman", serif', color: '#000', textAlign: 'center', lineHeight: 1.1 }}>Invoice</div>
            </div>
          </div>
        )}
        ...
        {(invoice?.delivery_address || quotation?.delivery_address) ? (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '20px', marginBottom: '16px' }}>
            ...
            <div style={{ textAlign: 'right', fontSize: '12px', lineHeight: '1.6', minWidth: '190px', flexShrink: 0 }}>
                  ...
                  {group.rows.map((entry, rowInGroup) => {
                    ...
                    return (
                      <tr key={idx}>
                        ...
                        <td style={{ textAlign: 'right', fontWeight: 700, verticalAlign: 'top', paddingTop: '8px', paddingRight: '8px', ...mergedCell }}>
                          {isFirst ? groupTotalAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : ''}
                        </td>
                      </tr>
                    );
                  })}
