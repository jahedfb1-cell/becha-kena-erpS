...
const Dashboard = () => {
  ...
  // Theme Styles Tokens (fixed to light mode)
  const theme = {
    pageBg: '#f8fafc',
    textMain: '#0f172a',
    textSub: '#475569',
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="36" height="36" style={{ opacity: 0.8, color: '#3b82f6' }}>
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="36" height="36" style={{ opacity: 0.8, color: '#8b5cf6' }}>
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="36" height="36" style={{ opacity: 0.8, color: '#64748b' }}>
            ...
            {top_selling_products.length === 0 ? (
              ...
              top_selling_products.map((prd, idx) => (
                <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', background: theme.itemBg, border: `1px solid ${theme.itemBorder}`, borderRadius: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: '#e0f2fe', color: '#0284c7', fontWeight: 800, fontSize: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                      #{idx + 1}
                    </div>
                    <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <button
              ...
              style={{
                ...
                background: hoveredAction === 0 ? '#e0f2fe' : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 1 ? '#e0f2fe' : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 2 ? '#e0f2fe' : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 3 ? '#e0f2fe' : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: `1px solid ${theme.itemBorder}`, paddingBottom: '14px' }}>
            ...
            <div style={{ display: 'flex', background: theme.itemBg, padding: '4px', borderRadius: '8px', border: `1px solid ${theme.itemBorder}` }}>
              ...
              <button
                ...
                style={{
                  border: 'none',
                  background: activeTab === 'quotes' ? '#ffffff' : 'transparent',
              ...
              recent_orders.length === 0 ? (
                ...
                recent_orders.map((order) => (
                  <div key={order.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: theme.itemBg, borderRadius: '10px', borderLeft: '4px solid #10b981', border: `1px solid ${theme.itemBorder}`, borderLeftWidth: '4px' }}>
                    <div>
                      <Link to={`/orders?search=${order.quotation_number}`} style={{ fontWeight: 800, fontSize: '13px', color: '#0284c7', textDecoration: 'none' }}>
              ...
              recent_quotations.length === 0 ? (
                ...
                recent_quotations.map((quote) => (
                  <div key={quote.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: theme.itemBg, borderRadius: '10px', borderLeft: '4px solid #f59e0b', border: `1px solid ${theme.itemBorder}`, borderLeftWidth: '4px' }}>
                    <div>
                      <Link to={`/quotations?search=${quote.quotation_number}`} style={{ fontWeight: 800, fontSize: '13px', color: '#d97706', textDecoration: 'none' }}>
