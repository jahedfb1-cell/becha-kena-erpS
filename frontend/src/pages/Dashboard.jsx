...
const Dashboard = () => {
  ...
  // Theme Styles Tokens
  const theme = {
    pageBg: isDarkMode ? '#080c14' : '#f4f6f9',
    textMain: isDarkMode ? '#f8fafc' : '#1e293b',
    textSub: isDarkMode ? '#94a3b8' : '#64748b',
    cardBg: isDarkMode ? 'rgba(17, 25, 40, 0.65)' : '#ffffff',
    cardBorder: isDarkMode ? 'rgba(255, 255, 255, 0.08)' : '#e2e8f0',
    cardShadow: isDarkMode ? '0 8px 32px 0 rgba(0, 0, 0, 0.37)' : '0 4px 15px rgba(0,0,0,0.05)',
    itemBg: isDarkMode ? 'rgba(255, 255, 255, 0.02)' : '#f8fafc',
    itemBorder: isDarkMode ? 'rgba(255, 255, 255, 0.04)' : '#edf2f7',
    chartGrid: isDarkMode ? 'rgba(255, 255, 255, 0.05)' : '#eaeaea',
  ...
  if (error) {
    return (
      <div className="content-container animate-fade-in" style={{ padding: '24px', background: theme.pageBg, minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div className="alert alert-danger" style={{ background: isDarkMode ? 'rgba(239, 68, 68, 0.1)' : '#f8d7da', border: isDarkMode ? '1px solid rgba(239, 68, 68, 0.2)' : '1px solid #f5c6cb', color: isDarkMode ? '#fca5a5' : '#721c24', padding: '24px', borderRadius: '12px', width: '100%', maxWidth: '500px', textAlign: 'center' }}>
          <h4 style={{ margin: '0 0 12px 0', fontWeight: 800, fontSize: '18px' }}>Server Connection Required</h4>
          <p style={{ margin: 0, fontSize: '14px' }}>{error}</p>
          <button onClick={() => window.location.reload()} className="btn btn-danger" style={{ marginTop: '20px', background: '#dc3545', color: '#fff', border: 'none', padding: '10px 20px', borderRadius: '6px', cursor: 'pointer', fontWeight: 700 }}>
            Retry Connection
          </button>
        </div>
      </div>
  ...
  const cards = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#10b981' }}>
    ...
    },
    {
      ...
      color: '#00c0ef', // Cyan/Teal
      borderGlow: 'rgba(0, 192, 239, 0.4)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#00c0ef' }}>
    ...
    },
    {
      ...
      color: '#ff4b5c', // Red
      borderGlow: 'rgba(255, 75, 92, 0.4)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#ff4b5c' }}>
    ...
    },
    {
      ...
      color: todayData.profit >= 0 ? '#10b981' : '#ff4b5c',
      borderGlow: todayData.profit >= 0 ? 'rgba(16, 185, 129, 0.4)' : 'rgba(255, 75, 92, 0.4)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: todayData.profit >= 0 ? '#10b981' : '#ff4b5c' }}>
    ...
    },
    {
      ...
      borderGlow: 'rgba(243, 156, 18, 0.4)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#f39c12' }}>
    ...
    },
    {
      ...
      color: '#0073b7', // Blue
      borderGlow: 'rgba(0, 115, 183, 0.4)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#0073b7' }}>
    ...
    },
    {
      ...
      color: '#6c757d', // Slate
      borderGlow: 'rgba(108, 117, 125, 0.3)',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="40" height="40" style={{ opacity: isDarkMode ? 0.35 : 0.25, color: '#6c757d' }}>
  ...
  return (
    <div className="content-container animate-fade-in" style={{ padding: '24px', background: theme.pageBg, minHeight: '100vh', position: 'relative', overflow: 'hidden', color: theme.textMain, transition: 'background 0.3s, color 0.3s' }}>
      ...
      {/* 3D background glowing blobs for dark mode */}
      {isDarkMode && (
        <>
          <div style={{ position: 'absolute', width: '350px', height: '350px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(99, 102, 241, 0.15) 0%, transparent 70%)', top: '-100px', left: '-100px', pointerEvents: 'none', zIndex: 0 }} />
          <div style={{ position: 'absolute', width: '450px', height: '450px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(236, 72, 153, 0.1) 0%, transparent 70%)', bottom: '5%', right: '-150px', pointerEvents: 'none', zIndex: 0 }} />
          <div style={{ position: 'absolute', width: '400px', height: '400px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(6, 182, 212, 0.08) 0%, transparent 70%)', top: '30%', left: '50%', transform: 'translate(-50%, -50%)', pointerEvents: 'none', zIndex: 0 }} />
        </>
      )}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px', position: 'relative', zIndex: 1, flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h1 style={{ margin: 0, fontSize: '28px', fontWeight: 800, color: isDarkMode ? '#ffffff' : '#1e293b', letterSpacing: '-0.5px' }}>
            Dhaka Blinds Dashboard
          </h1>
          <p style={{ margin: '6px 0 0 0', fontSize: '13px', color: theme.textSub, fontWeight: 500 }}>
            Welcome back, <strong style={{ color: theme.textMain }}>{user?.name}</strong> ({capitalize(user?.role)}). Business summary snapshot.
          </p>
        </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: isHovered 
                  ? (isDarkMode ? `0 15px 30px rgba(0,0,0,0.4), 0 0 15px ${card.borderGlow}` : '0 10px 25px rgba(0,0,0,0.1)') 
                  : theme.cardShadow,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(310px, 1fr))', gap: '24px', marginBottom: '28px', position: 'relative', zIndex: 1 }}>
        ...
        {/* NEW FEATURE: Best Sales Products / Top Selling Products Widget */}
        <div style={{ ...glassmorphismStyle, borderRadius: '16px', padding: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <Link to="/products" style={{ fontSize: '11px', fontWeight: 800, color: '#00f2fe', textDecoration: 'none' }}>
              All Products →
            </Link>
          </div>
            ...
            {top_selling_products.length === 0 ? (
              ...
              top_selling_products.map((prd, idx) => (
                <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', background: theme.itemBg, border: `1px solid ${theme.itemBorder}`, borderRadius: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: isDarkMode ? 'rgba(0,242,254,0.1)' : '#e0f2fe', color: '#00c0ef', fontWeight: 800, fontSize: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                      #{idx + 1}
                    </div>
                    <div>
        ...
        <div style={{ ...glassmorphismStyle, borderRadius: '16px', padding: '24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', background: theme.itemBg, border: `1px solid ${theme.itemBorder}`, borderRadius: '12px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(16, 185, 129, 0.1)', color: '#10b981', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '18px' }}>
                💵
              </div>
              <div style={{ flex: 1 }}>
            ...
            {/* Bank Wallet */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', background: theme.itemBg, border: `1px solid ${theme.itemBorder}`, borderRadius: '12px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(56, 189, 248, 0.1)', color: '#38bdf8', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '18px' }}>
                🏦
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '11px', color: theme.textSub, fontWeight: 700, letterSpacing: '0.5px' }}>BANK BOOK BALANCE</div>
                <div style={{ fontSize: '16px', fontWeight: 800, color: '#38bdf8', marginTop: '3px' }}>{formatCurrency(walletBalances.bank)}</div>
              </div>
            </div>

            {/* Mobile Banking Wallet */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', background: theme.itemBg, border: `1px solid ${theme.itemBorder}`, borderRadius: '12px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(168, 85, 247, 0.1)', color: '#c084fc', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '18px' }}>
                📱
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '11px', color: theme.textSub, fontWeight: 700, letterSpacing: '0.5px' }}>MOBILE BANKING BALANCE</div>
                <div style={{ fontSize: '16px', fontWeight: 800, color: '#c084fc', marginTop: '3px' }}>{formatCurrency(walletBalances.mobile)}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <button
              ...
              style={{
                ...
                background: hoveredAction === 0 ? (isDarkMode ? 'rgba(99, 102, 241, 0.15)' : '#eff6ff') : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 1 ? (isDarkMode ? 'rgba(99, 102, 241, 0.15)' : '#eff6ff') : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 2 ? (isDarkMode ? 'rgba(99, 102, 241, 0.15)' : '#eff6ff') : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '10px',
                border: `1px solid ${theme.itemBorder}`,
                background: hoveredAction === 3 ? (isDarkMode ? 'rgba(99, 102, 241, 0.15)' : '#eff6ff') : theme.itemBg,
                cursor: 'pointer',
                textAlign: 'center',
                fontWeight: 700,
                fontSize: '13px',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px', marginBottom: '28px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: `1px solid ${theme.itemBorder}`, paddingBottom: '14px' }}>
            ...
            <div style={{ display: 'flex', background: theme.itemBg, padding: '4px', borderRadius: '8px', border: `1px solid ${theme.itemBorder}` }}>
              <button
                ...
                style={{
                  border: 'none',
                  background: activeTab === 'orders' ? (isDarkMode ? 'rgba(255,255,255,0.08)' : '#fff') : 'transparent',
                  color: activeTab === 'orders' ? '#00f2fe' : theme.textSub,
                  padding: '6px 14px',
                  borderRadius: '6px',
                  fontSize: '11px',
                  fontWeight: 800,
              ...
              <button
                ...
                style={{
                  border: 'none',
                  background: activeTab === 'quotes' ? (isDarkMode ? 'rgba(255,255,255,0.08)' : '#fff') : 'transparent',
                  color: activeTab === 'quotes' ? '#f39c12' : theme.textSub,
                  padding: '6px 14px',
                  borderRadius: '6px',
                  fontSize: '11px',
                  fontWeight: 800,
            ...
            {activeTab === 'orders' ? (
              recent_orders.length === 0 ? (
                ...
                recent_orders.map((order) => (
                  <div key={order.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: theme.itemBg, borderRadius: '10px', borderLeft: '4px solid #10b981', border: `1px solid ${theme.itemBorder}`, borderLeftWidth: '4px' }}>
                    <div>
                      <Link to={`/orders?search=${order.quotation_number}`} style={{ fontWeight: 800, fontSize: '13px', color: '#007bff', textDecoration: 'none' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <span style={{ fontSize: '9px', background: 'rgba(16, 185, 129, 0.1)', color: '#10b981', padding: '2px 8px', borderRadius: '10px', fontWeight: 800, textTransform: 'uppercase', display: 'inline-block', marginTop: '4px' }}>
                        {order.status}
                      </span>
                    </div>
                  </div>
              ...
              recent_quotations.length === 0 ? (
                ...
                recent_quotations.map((quote) => (
                  <div key={quote.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: theme.itemBg, borderRadius: '10px', borderLeft: '4px solid #f39c12', border: `1px solid ${theme.itemBorder}`, borderLeftWidth: '4px' }}>
                    <div>
                      <Link to={`/quotations?search=${quote.quotation_number}`} style={{ fontWeight: 800, fontSize: '13px', color: '#f39c12', textDecoration: 'none' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <span style={{ fontSize: '9px', background: 'rgba(243, 156, 18, 0.1)', color: '#f39c12', padding: '2px 8px', borderRadius: '10px', fontWeight: 800, textTransform: 'uppercase', display: 'inline-block', marginTop: '4px' }}>
                        {quote.status}
                      </span>
                    </div>
                  </div>
        ...
        <div style={{ ...glassmorphismStyle, borderRadius: '16px', padding: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <Link to="/reports" style={{ fontSize: '11px', fontWeight: 800, color: '#00f2fe', textDecoration: 'none' }}>
              View Due Report →
            </Link>
          </div>
            ...
            {top_due_customers.length === 0 ? (
              ...
              top_due_customers.map((c, idx) => (
                <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: `1px solid ${theme.itemBorder}` }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontWeight: 800, fontSize: '13px', color: '#ff4b5c' }}>
      ...
      {/* REPOSITIONED TO ABSOLUTE BOTTOM: Sales & Purchases Report Chart */}
      <div style={{ ...glassmorphismStyle, borderRadius: '16px', padding: '24px', position: 'relative', zIndex: 1 }}>
          ...
          {hoveredBar && (
            <div
              style={{
                ...
                background: isDarkMode ? 'rgba(15, 23, 42, 0.95)' : '#1e293b',
                color: '#fff',
                padding: '8px 12px',
                borderRadius: '8px',
                fontSize: '12px',
