        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '12px', padding: '24px', boxShadow: 'var(--shadow)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', marginBottom: '16px' }}>
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#64748b', margin: '4px 0 0 0', lineHeight: 1.5 }}>
                Use as a mobile/desktop app with full-screen experience and fast access.
              </p>
            </div>
          </div>

          {/* Status & One-Click PWA Install */}
            ...
            {isInstalled ? (
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: '13px', color: '#166534', marginTop: '2px' }}>You are using the installed app or it is already placed on your Home Screen / Desktop.</div>
                </div>
              </div>
            ) : (
              <div style={{
                ...
                <div>
                  <div style={{ fontWeight: 700, color: 'var(--text-heading)', fontSize: '15px' }}>
                    {canInstall ? '⚡ 1-Click Web App Install' : '📲 Install Web App (PWA)'}
                  </div>
                  <div style={{ fontSize: '13px', color: '#64748b', marginTop: '4px' }}>
                    {canInstall
                      ? 'Click button below to add Dhaka Blinds directly to your home screen or desktop.'
                      : 'Add to Home Screen without downloading any heavy files (runs instantly).'}
                  </div>
                </div>
                {canInstall && (
                  <button
                  ...
                  >
                    {installing ? 'Installing...' : '⬇️ Install App Now'}
                  </button>
                )}
              </div>
            )}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
            ...
            <div style={{ background: 'var(--bg-base)', border: '1px solid var(--border)', borderRadius: '8px', padding: '16px' }}>
              <div style={{ fontWeight: 700, color: 'var(--text-heading)', fontSize: '14px', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span>📱 Android (Google Chrome)</span>
              </div>
              <ol style={{ margin: 0, paddingLeft: '18px', fontSize: '13px', color: 'var(--text-main)', lineHeight: 1.7 }}>
                <li>Tap the <strong>3 dots (⋮)</strong> at top right corner.</li>
            ...
            <div style={{ background: 'var(--bg-base)', border: '1px solid var(--border)', borderRadius: '8px', padding: '16px' }}>
              ...
              <ol style={{ margin: 0, paddingLeft: '18px', fontSize: '13px', color: 'var(--text-main)', lineHeight: 1.7 }}>
                <li>Tap the <strong>Share (⬆️)</strong> button in Safari toolbar.</li>
